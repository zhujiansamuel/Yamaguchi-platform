"""
Celery configuration for Send Notification Email Worker.
...
# Create Celery app
app = Celery('send_notification_email_worker')
...
app.conf.update(
    ...
    task_routes={
        'apps.data_acquisition.EmailParsing.tasks_send_notification_email.*': {
            'queue': 'send_notification_email_queue'
        },
    },
    task_default_queue='send_notification_email_queue',
)

# Auto-discover tasks
app.autodiscover_tasks(
    ['apps.data_acquisition.EmailParsing'],
    related_name='tasks_send_notification_email'
)
...
def debug_task(self):
    ...
    print(f'Send Notification Email Worker - Request: {self.request!r}')
