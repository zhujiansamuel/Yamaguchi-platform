"""
Celery configuration for Order Confirmation Notification Email Worker.
...
# Create Celery app
app = Celery('order_confirmation_notification_email_worker')
...
app.conf.update(
    ...
    task_routes={
        'apps.data_acquisition.EmailParsing.tasks_order_confirmation_notification_email.*': {
            'queue': 'order_confirmation_notification_email_queue'
        },
    },
    task_default_queue='order_confirmation_notification_email_queue',
)

# Auto-discover tasks
app.autodiscover_tasks(
    ['apps.data_acquisition.EmailParsing'],
    related_name='tasks_order_confirmation_notification_email'
)
...
def debug_task(self):
    ...
    print(f'Order Confirmation Notification Email Worker - Request: {self.request!r}')
