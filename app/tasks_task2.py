...
# ── 在此处填入 task2 的核心业务逻辑函数 ──────────────────────────────────────


async def run_task2_task(webhook_url: Optional[str] = None):
    print("--- Background task: run_task2_task started ---", flush=True)
    result_payload = {}
    try:
        # ── 在此处填入 task2 的主流程 ────────────────────────────────────────
        # 例如：
        ...
        raise NotImplementedError("run_task2_task is not implemented yet.")

    except Exception as e:
        error_message = f"Error: {e}"
        print("--- Background task: run_task2_task encountered an error ---", flush=True)
        ...
        print("--- Background task: run_task2_task finished ---", flush=True)
