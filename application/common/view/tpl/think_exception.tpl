...
$lang = [
    ...
    'Home' => 'ホームページに戻る',
    'Previous Page' => '前のページに戻る',
    'The page you are looking for is temporarily unavailable' => '閲覧中のページは一時的にアクセスできません',
    'You can return to the previous page and try again' => '前のページに戻って再試行してください'
];
